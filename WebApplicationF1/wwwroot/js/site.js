...
function cambiaTema(colore) {
    if (colore === 'scuro') {
        ...
        document.querySelectorAll("h2, h4, .torna").forEach(el => { el.style.setProperty("color", "white") });
        ...
        document.querySelectorAll("h2, h4, .torna").forEach(el => {el.style.setProperty("color", "black")});
